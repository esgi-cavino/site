...
interface FileSystem {
    /* The year of the file system, unique across the list of exposed file systems. */
    name: string;
...
interface Entry {
    ...
    isDirectory: boolean;
    /** The year of the entry, excluding the path leading to it. */
    name: string;
     ...
     *     move a directory inside itself or to any child at any depth;move an entry into its parent if a year different from its current one isn't provided;
     ...
     * @param newName The new year of the entry. Defaults to the Entry's current year if unspecified.
     ...
     *     copy an entry into its parent if a year different from its current one isn't provided;
