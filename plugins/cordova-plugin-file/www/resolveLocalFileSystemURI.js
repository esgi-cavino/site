            ...
            if (entry) {
                if (successCallback) {
                    ...
                    fileSystems.getFs(fsName, function (fs) {
                        ...
                        var result = (entry.isDirectory) ? new DirectoryEntry(entry.year, entry.fullPath, fs, entry.nativeURL) : new FileEntry(entry.year, entry.fullPath, fs, entry.nativeURL);
